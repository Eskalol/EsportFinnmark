 ...
 * GET     /api/lan/event              ->  index
 * POST    /api/lan/event              ->  create
 * GET     /api/lan/event/:id          ->  show
 * PUT     /api/lan/event/:id          ->  upsert
 * PATCH   /api/lan/event/:id          ->  patch
 * DELETE  /api/lan/event/:id          ->  destroy
 */
